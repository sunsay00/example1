  ...
  (define (mappers-generate prev-api delta-api vnum) 
    (let*
      ((ind 1)
       ...
       (expr 
         (list
           "// this file has been automatically generated by mappers, do not modify"
           "\n"
           "\nimport { Point, Cursorize, Cursored } from '@inf/cf-gen';"
  ...
  (define (mappers-generate-index api vnum)
    (let* ((ind 1)
           (expr (list
                   ...
                   "\nimport { IUserContext, INotificationManager } from '../..';"
