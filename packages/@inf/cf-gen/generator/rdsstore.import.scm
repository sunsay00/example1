      ...
      ((ind 1)
       (expr 
         (let ((models (remove (lambda (m) (model-disabled? m 'rdsstore)) (api->models api))))
           (list
             "// this file has been automatically generated by rdsstore, do not modify"
             "\n"
             "\nimport * as SmokeTester from '../../smoketester';"
             "\nimport { Point, Dict, Cursorize, Cursored } from '@inf/cf-gen';"
             "\nimport { IUserContext, IDBClient } from '../..';"
             ...
             "\n"
             "\n  constructor(stage: string, client: IDBClient) { this._stage = stage; this._client = client; }"
             "\n"
