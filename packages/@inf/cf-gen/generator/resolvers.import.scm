       ...
       (expr 
         (list
           ...
           "\nimport Mapper from '../../mapper';"
					 "\nimport { ITestingService } from '../../../../../../tools/testingservice';"
           "\nimport { IUserContext } from '../../../../../../types';"
					 "\n"
					 "\nexport default <C extends IUserContext>(stage: string, mapper: Mapper<C>, testing: ITestingService<C>) => ({\n"
           (map (lambda (scalar) (scalar-emit ind scalar)) (api->scalars api))
					 ...
					 "\n    testUnauthorized: async (obj: any, { arg }: any, $ctx: C, info: any) => { return await testing.unauthorized($ctx, getFieldList(info), mapper, arg); },"
					 "\n    testAdminAuthorized: async (obj: any, { arg }: any, $ctx: C, info: any) => { return await testing.adminAuthorized($ctx, getFieldList(info), mapper, arg); },"
					 "\n    testAuthorized: async (obj: any, { arg }: any, $ctx: C, info: any) => { if (arg !== 'pong') { throw new Error('invalid test argument'); } return await testing.authorized($ctx, getFieldList(info), mapper, arg); },"
					 "\n"
