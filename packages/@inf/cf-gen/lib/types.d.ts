...
export declare type Cursorize = {
    cursor?: string;
};
export declare type Cursored<T> = {
    cursor?: string;
    data: T;
};
...
export declare type IUserContext = {
    sub: string;
    groups?: string[];
};
...
export declare type QueryParam = object | number | string | undefined;
export declare type IDBClient = {
...
export declare type INotificationManager<C extends IUserContext> = {
